        ...
        'decimal': {
            ...
            regex: {
                number: function (opts) {
                    ...
                    //alert("^" + signedExpression + "(\\d+|\\d{1," + opts.groupSize + "}((" + escapedGroupSeparator + "\\d{" + opts.groupSize + "})?)+)(" + escapedRadixPoint + "\\d" + digitExpression + ")?$");
        ...
        'integer': {
            regex: {
                number: function (opts) {
                    ...
                    //alert("^" + signedExpression + "(\\d+|\\d{1," + opts.groupSize + "}((" + escapedGroupSeparator + "\\d{" + opts.groupSize + "})?)+)$");
