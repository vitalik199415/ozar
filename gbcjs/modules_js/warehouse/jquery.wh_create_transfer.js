(function( $ )
{
$.fn.wh_create_transfer = function(method, options)
{
	var option = $.extend(
	{
		order_id : false,
		...
		wh_create_transfer_products_grid : '#wh_create_transfer_products_grid',
		transfer_wh_add_product : '#transfer_wh_add_product',
		view_pr_to_transfer : '.view_pr_to_transfer',
		view_create_transfer_pr_block : '#view_create_transfer_pr_block',
		back_to_wh_pr : '.back_to_wh_pr',
		to_transfer_status : '#to_transfer_status',
		
		delete_pr_from_transfer : '.delete_pr_from_transfer',
		view_edit_pr_transfer_qty : '.view_edit_pr_transfer_qty'
	},options);
	...
	var methods = new Object(
	{
		...
		{
			$(this).on('click', option.transfer_wh_add_product, function()
			{
				jQuery.ajaxAG(
				{
					url: $(this).attr('href'),
