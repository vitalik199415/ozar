...
if(isset($PRS_array['products']))
{
	...
	<div class="products_block_short products_short_block">
	    ...
	    <div class="products_block_short_img" align="center">	
            ...
            {
	        ?>	
				<div id="slider<?=$ms['ID']?>_container" style="position: relative; top: 0px; left: 0px; width: 225px; height: 310px; overflow: hidden; ">
			        ...
			        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 225px; height: 310px; overflow: hidden;">
		                <?
