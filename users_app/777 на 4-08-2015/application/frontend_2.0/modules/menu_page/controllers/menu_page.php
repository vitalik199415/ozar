<?php
//require_once "./application/frontend_2.0/modules/menu_page/controllers/menu_page.php";
class Menu_page extends AG_Controller
{
	...
	public function index()
	{
		...
		$this->template->add_view_to_template('footer_menu_block', 'menu_page/footer_menu', $view_array);
