...
{
	protected $additional_js = array('jquery.carouFredSel-5.6.1', 'jquery.gbc_dropdown_menu', 'jquery.elevatezoom','jssor.slider.min','jssor','jquery.slicknav','jquery-scrolltofixed','jquery.jbcallme','readmore','jquery.scrollUp','jquery.fancybox-1.2.1.pack','jquery.arcticmodal-0.3.min');
	protected $additional_css = array('style_carousel','font-awesome','slicknav','jquery.jbcallme','jquery.fancybox','jquery.arcticmodal-0.3');
