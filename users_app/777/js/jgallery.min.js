    ...
    var a = {
        ...
        j = function() {
            ...
            return function(c) {
                ...
                c = a.extend({}, d, c), this.each(function() {
                    var d, e, f = a(this),
                        g = f.is(".overlayContainer:has(.overlay)"),
                        h = function() {
                            var b = Math.max(f.offset().top, a("body, html").scrollTop()),
                                c = Math.min(f.offset().top + f.outerHeight(), a("body, html").scrollTop() + a(window).height()),
                                d = b + (c - b) / 2 - f.offset().top;
                            e.css({
                                top: d + "px"
                            })
                        },
                        i = function() {
                            f.children(".overlay").css({
                                width: f.outerWidth(),
                                height: f.is("body") ? b.outerHeight() : f.outerHeight()
                            })
                        },
                        j = function() {
                            c.fadeIn ? d.fadeIn(500) : d.show()
                        },
                        k = function() {
                            c.fadeOut ? d.fadeOut(500) : d.hide()
                        },
                        l = function() {
                            c.fadeInLoader ? e.not(":visible").fadeIn(500) : e.not(":visible").show()
                        },
                        m = function() {
                            c.fadeOutLoader ? e.filter(":visible").fadeOut(500) : e.filter(":visible").hide()
                        };
                    a(window).scroll(function() {
                        h()
                    }), a(window).resize(function() {
                        h(), i()
                    }), f.is("table") && f.parent().is(".overlayContainer") && (f = f.parent()), g || (f.is("table") && (f.wrap("<div></div>"), f = f.parent()), f.addClass("overlayContainer"), f.append('<div class="overlay" style="display: none;"><div class="imageLoaderPositionAbsolute" style="display: none;"></div></div>'), c.afterInit()), d = f.children(".overlay"), e = f.find(".imageLoaderPositionAbsolute"), d.stop(!1, !0), e.stop(!1, !0), c.show ? j() : c.hide && k(), c.showLoader ? l() : c.hideLoader && m(), h(), i()
                })
            }
        }(),
        k = function(a) {
            var b = jQuery;
            return b.fn.overlay1 = a,
                function(a) {
                    a = b.extend({
                        interval: 1e3,
                        skip: ":not(*)",
        ...
        s = function(a) {
            ...
            return e.prototype = {
                ...
                show: function() {
                    var a = this;
                    this.getElement().is(".hidden") && (this.getElement().removeClass("hidden"), this.getElement().is(".loaded") ? (this._showNextThumb(), this.$a.parent(".album:not(.active)").children(".hidden").removeClass("hidden")) : this.getElement().jLoader({
                        start: function() {},
                        success: function() {
        ...
        t = function(a) {
            ...
            var c = function(a, c) {
                this.options = b.extend({}, {
                    thumbsHidden: !0
                }, c), this.jGallery = a, this.isSlider = a.isSlider(), this.$element = a.$this, this.booIsAlbums = a.booIsAlbums, this.$tmp, this.intI = 1, this.intJ = 1, this.intNo, this.$thumbnailsContainerInner = this.jGallery.$jgallery.find(".jgallery-thumbnails .jgallery-container-inner"), this.start()
            };
            return c.prototype = {
                start: function() {
                    var a = this,
                        c = this.jGallery.isSlider() ? ".album:has(img)" : ".album:has(a:has(img))";
                    b("body").append('<div id="jGalleryTmp" style="position: absolute; top: 0; left: 0; width: 0; height: 0; z-index: -1; overflow: hidden;">' + this.$element.html() + "</div>"), this.$tmp = b("#jGalleryTmp"), this.$thumbnailsContainerInner.html(""), this.booIsAlbums ? this.$tmp.find(c).each(function() {
                        a.insertAlbum(b(this))
                ...
                insertImages: function(a, c) {
                    var d = this,
                        e = this.jGallery.isSlider() ? "img" : "a:has(img)";
                    this.intNo = 1, a.find(e).each(function() {
                        d.insertImage(b(this), c)
                    })
                },
                insertImage: function(a, c) {
                    var d, e;
                    a.is("a") ? (c.append('<a href="' + a.attr("href") + '">' + this.generateImgTag(a.find("img").eq(0)).outerHtml() + "</a>"), this.options.thumbsHidden && c.children(":last-child").addClass("hidden")) : a.is("img") && (d = c.append(b('<a href="' + a.attr("src") + '">' + this.generateImgTag(a).outerHtml() + "</a>")).children(":last-child"), e = a.parent(), this.isSlider && e.is("a") && (d.attr("link", e.attr("href")), e.is("[target]") && d.attr("target", e.attr("target")))), c.children(":last-child").attr("data-jgallery-photo-id", this.intI++).attr("data-jgallery-number", this.intNo++)
                },
                generateImgTag: function(a) {
                    var c = b('<img src="' + a.attr("src") + '" />');
                    return a.is("[alt]") && c.attr("alt", a.attr("alt")), a.is("[data-jgallery-bg-color]") && c.attr("data-jgallery-bg-color", a.attr("data-jgallery-bg-color")), a.is("[data-jgallery-text-color]") && c.attr("data-jgallery-text-color", a.attr("data-jgallery-text-color")), c
                },
                refreshThumbsSize: function() {
                    ...
                    this.$thumbnailsContainerInner.find("img").each(function() {
                        var c = b(this),
                            d = new Image;
                        d.src = c.attr("src"), d.width / d.height < a.thumbWidth / a.thumbHeight ? c.addClass("thumb-vertical").removeClass("thumb-horizontal") : c.addClass("thumb-horizontal").removeClass("thumb-vertical"), d.width / d.height < a.thumbWidthOnFullScreen / a.thumbHeightOnFullScreen ? c.addClass("thumb-on-full-screen-vertical").removeClass("thumb-on-full-screen-horizontal") : c.addClass("thumb-on-full-screen-horizontal").removeClass("thumb-on-full-screen-vertical")
                    })
                }
            }, c
        }(i),
        u = function(a, b, c, d, e, f, g, h) {
            var i = jQuery,
                j = i("body");
            i.fn.jLoader = a, i.fn.overlay1 = b;
            var k = function(a) {
            ...
            return k.prototype = {
                ...
                refreshContainerSize: function() {
                    var a = this.jGallery.isSlider() ? 0 : this.$container.find(".nav-bottom").outerHeight(),
                        b = !this.jGallery.isSlider() && !this.thumbnails.getElement().is(".inactive"),
                ...
                setImgSizeForFit: function(a) {
                    var b = this.jGallery.isSlider() ? 0 : this.$container.find(".nav-bottom").outerHeight(),
                        c = !this.jGallery.isSlider() && !this.thumbnails.getElement().is(".inactive");
                    a.css({
                        width: "auto",
                        height: "auto",
                        "min-width": 0,
                ...
                loadPhoto: function(a, b, c) {
                    ...
                    h.jLoader({
                        ...
                        skip: ".loaded",
                        start: function() {
                            d.jGallery.options.preloadAll ? (d.$container.find(".overlay .imageLoaderPositionAbsolute:not(:has(.progress-value))").addClass("preloadAll").append('<span class="progress-value"></span>'), d.$container.find(".progress-value").html("0")) : d.$container.find(".overlay .imageLoaderPositionAbsolute:not(:has(.fa-spin))").append('<span class="fa fa-spin fa-spinner"></span>')
                        },
                        success: function() {
                            a.find("img").addClass("loaded"), d.$container.overlay1({
                                hide: !0,
                                hideLoader: !0
        ...
        v = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
            ...
            return u.prototype = {
                ...
                hideThumbnailsBar: function() {
                    this.thumbnails.getElement().addClass("inactive"), this.zoom.$container.find(".minimalize-thumbnails").hide()
                },
                showThumbnailsBar: function() {
                    this.thumbnails.getElement().removeClass("inactive"), this.options.canMinimalizeThumbnails && this.options.thumbnails ? this.zoom.$container.find(".minimalize-thumbnails").show() : this.zoom.$container.find(".minimalize-thumbnails").hide()
                },
                ...
                setUserOptions: function() {
                    ...
                    this.refreshAttrClasses(), this.options.canZoom ? this.zoom.$resize.show() : this.zoom.$resize.hide(), this.options.canChangeMode ? this.zoom.$changeMode.show() : this.zoom.$changeMode.hide(), "standard" === this.options.mode ? this.zoom.$changeMode.removeClass("fa-compress").addClass("fa-expand") : this.zoom.$changeMode.removeClass("fa-expand").addClass("fa-compress"), this.options.canClose ? this.zoom.$container.find(".jgallery-close").show() : this.zoom.$container.find(".jgallery-close").hide(), this.refreshThumbnailsVisibility(), this.options.slideshow ? this.zoom.$slideshow.show() : this.zoom.$slideshow.hide(), this.options.slideshow && this.options.slideshowCanRandom && this.options.slideshowAutostart ? this.zoom.$random.show() : this.zoom.$random.hide(), this.options.slideshow && this.options.slideshowCanRandom && this.options.slideshowRandom ? this.zoom.$random.addClass("active") : this.zoom.$random.removeClass("active"), this.options.thumbnailsFullScreen && this.options.thumbnails ? this.zoom.$container.find(".full-screen").show() : this.zoom.$container.find(".full-screen").hide(), this.options.hideThumbnailsOnInit && this.options.thumbnails ? this.thumbnails.hide() : this.thumbnails.show(), this.options.titleExpanded ? this.zoom.$title.addClass("expanded") : this.zoom.$title.removeClass("expanded"), this.setColours({
