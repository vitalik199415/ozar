<div class="content" align="center">
                        ...
                        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1280px;
                            ...
                            <div>
                                ...
                                <div class="slide_href" align="right">
                                    <a href="/category-women-jeans-clothing">Женская</a>
                                    <div class="clear_both"></div>
                                    <a href="/category-mens-jeans-clothing">Мужская</a>
                                    <div class="clear_both"></div>
                                    <a href="/category-baby-jeans-clothing">Подростковая</a>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="slide_href" align="right">
                                    <a href="/category-shirts">Рубашки</a>
                                    <a href="/category-mens-sweaters">Свитера</a>
                                    <div class="clear_both"></div>
                                    <a href="/category-mens-jeans-model">Джинсы</a>
                                    <a href="/category-denim-jackets">Куртки</a>
                                    <div class="clear_both"></div>
                                    <a href="/category-denim-jackets">Пиджаки</a>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="slide_href" align="right">
                                    <a href="/category-for-newborns">Для новородженных</a>
                                    <div class="clear_both"></div>
                                    <a href="/category-for-boys">Для мальчиков</a>
                                    <div class="clear_both"></div>
                                    <a href="/category-for-girls">Для девочек</a>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="slide_href" align="right">
                                    <a href="/category-linens">Постельное белье</a>
                                    <a href="/category-towels">Полотенца</a>
                                    <a href="/category-for-kitchen">Товары для кухни</a>
                                    <a href="category-tablecloths">Скатерти/Салфетки</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="work">
            <div class="test_form">
                <div id="jbCallme_form" class="jbCallme2" style="display: block;">
                    <form class="jb_form2">
                        <div class="jb_input2">
                            <input required="required" placeholder="Страна" type="text" name="country">
                        </div>
                        <div class="jb_input2">
                            <input required="required" placeholder="Ф.И.О" type="text" name="name">
                        </div>
                        <div class="jb_input2">
                            <input placeholder="Номер телефона" type="text" name="tel">
                        </div>
                        <div class="jb_input2">
                            <input placeholder="E-mail" type="text" name="email">
                        </div>
                        <div class="jb_input2">
                            <input placeholder="Skype" type="text" name="skype">
                        </div>
                        <div class="jb_input2">
    ...
    <div class="work">
        <div class="popular_categories_block">
            ...
            <a href="/category-women-bags" class="block woman_bags">
                <div class="popular_categories_name">
                    <span>женские сумки</span>
                </div>
            </a>
            <a href="/category-shirts" class="block man_rub">
                <div class="popular_categories_name">
                    <span>мужские рубашки</span>
                </div>
            </a>
            <a href="/category-women-jeans-model" class="block woman_jeans">
                <div class="popular_categories_name">
                    <span>женские джинсы</span>
                </div>
            </a>
            <a href="/category-mens-jeans-model" class="block man_jeans">
                <div class="popular_categories_name">
                    <span>мужские джинсы</span>
                </div>
            </a>
            <a href="/category-mens-sweaters" class="block man_svitera">
                 <div class="popular_categories_name">
        ...
        <a href="#" id="m-customer-reg-banner" class="registration_baner">
            <div class="top_text">
                2%
            </div>
...
<script>
     $('#m-customer-reg-banner').on('click', function(event) {
      $('#customer_registration').trigger('click');
     });
    </script>
        <div class="our_partners">
            ...
            <script>
                ...
                <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width:1280px; height: 150px; overflow: hidden;">
                    ...
                    <div>
                        <div class="partner">
                            <a href="http://disamkargo.com/" class="logo_kargo" target="_blank"></a>
                        </div>
                    </div>
