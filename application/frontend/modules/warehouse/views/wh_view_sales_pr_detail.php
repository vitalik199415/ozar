...
<div style="margin:0 0 10px 0; text-align:left;"><a href="<?=set_url('*/warehouses_logs/ajax_view_sales/wh_id/'.$wh_id.'/log_id/'.$log_id)?>" class="back_to_wh_sale">К списку продуктов продажи</a></div>
