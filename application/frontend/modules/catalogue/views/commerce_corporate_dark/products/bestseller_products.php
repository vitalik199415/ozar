						...
						<div class="base_center_repeat">
							<div class="carousel_product_block">
								...
								if(isset($ms['timage']))
								{
									...
									<a href="<?=$ms['bimage']?>" title="<?=quotes_to_entities($ms['image_name'])?>" class="highslide" onclick="return hs.expand(this, pr_config_highslide_bestseller_products)">
									<?
