...
?>
<script>
	var pr_config_highslide_related_products_<?=$PRD_ID?> = {
		slideshowGroup: 'pr_related_group_<?=$PRD_ID?>',
		transitions: ['expand', 'crossfade']
	};
</script>
<div class="products_carousel_block tab_related_block">
<div class="block">
		<ul id="tab_related_products_<?=$PRD_ID?>">
			<?php
						...
						<div class="base_center_repeat">
							<div class="carousel_product_block">
								...
								if(isset($ms['timage']))
								{
									...
									<a href="<?=$ms['bimage']?>" title="<?=quotes_to_entities($ms['image_name'])?>" class="highslide" onclick="return hs.expand(this, pr_config_highslide_related_products_<?=$PRD_ID?>)">
									<?
