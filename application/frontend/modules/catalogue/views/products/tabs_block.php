<div class="tabs_block">
	<ul class="tabs">
		...
		{
		?>
		<li><a href="#"><div><?=$this->lang->line('products_description')?></div></a></li>
		<?
		}
		...
		{
		?>
		<li><a href="#"><div><?=$this->lang->line('products_review')?></div></a></li>
		<?
		}
		if($PRD_array['product_settings']['related_on'] == 1 && count($PRD_array['related_products']['related_products']) > 0)
		{
		?>
		<li><a href="#" id="related"><div><?=$this->lang->line('products_related')?></div></a></li>
		<?
		}
		?>
	</ul>
