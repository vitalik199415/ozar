...
При оплате с помощью карты или счета "ПриватБанк" комиссия равна 1.5% от суммы инвойса, с учетом комисии сумма к оплате <b><?=$amount_pb?> <?=$order['currency_name']?></b>
</div>
...
При оплате с помощью карты или счета других банков комиссия равна 3.5% от суммы инвойса, с учетом комисии сумма к оплате <b><?=$amount_other?> <?=$order['currency_name']?></b>
</div>
<div style="margin:15px 0 0 0;" align="center">
<form action='<?=$url?>' method='POST'>
