<?php
if(isset($PRD_array) && isset($PRD_block_id) && isset($wh_id) && isset($sale_id))
{
?>
	...
	<div class="product_detail_block" id="<?=$PRD_block_id?>">
		<div class="block">
			<div style="padding:5px 0 10px 0;">
				<a href="<?=set_url('warehouse/warehouses_sales/ajax_get_wh_shop_products_grid/wh_id/'.$wh_id.'/sale_id/'.$sale_id)?>" id="back_to_products_top">Назад к списку продуктов</a>
			</div>
			...
			<td valign="top">
				...
				<div class="add_to_cart_bot">
					<div class="add_to_cart"><div class="add_to_cart_input">Количество : <input type="text" name="qty" value="1" autocomplete="off"><div class="real_qty_block" id="real_qty_block"></div><div class="add_to_cart_input">Цена : <input type="text" class="price" name="price_value" value="" autocomplete="off"></div></div><a href="<?=set_url('warehouse/warehouses_sales/ajax_add_product_to_cart/wh_id/'.$wh_id.'/sale_id/'.$sale_id)?>" class="to_cart" id="to_cart"><span>Добавить к заказу</span></a></div>
				</div>
				<div class="form_message_block create_sale_message_block" id="pr_sale_message_block">
