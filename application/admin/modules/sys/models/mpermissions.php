...
class Mpermissions extends AG_Model {
    ...
    public $menu = array(
        ...
        11 => array(
            ...
            64  => array('Массовое изменение цен', 'catalogue/catalogue_mass_edit_price', 4)
        ),
        12 => array(
        ...
        61 => array(
            62  => array('Групы фильтров', 'catalogue/products_types', 4),
            63  => array('SEO наборы фильтров', 'catalogue/products_types_set', 4)
        ),
        15 => array(
