...
function helper_users_modules_grid_build($grid) {
    $grid->add_button(
    ...
    $grid->set_checkbox_actions(
        ...
        array(
            ...
            'name'  => 'users_modules_grid_select'
        )
    );
...
function helper_users_modules_form_build($data = array(), $save_param = '') {
    $form_id = 'users_modules_add_edit_form';
    $CI = &get_instance();
...
/*  End of file users_modules_helper.php  */