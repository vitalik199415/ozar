<?php
class Mnews_settings extends AG_Model
{
	const MID				= '3';
	...
	{
		$this->load->helper('news/news_settings_helper');
		$data['img_settings']['img_settings'] = $this->get_news_settings(TRUE);
		helper_news_settings_form_build($data);
	}
	
	public function get_news_settings($return_key_value = FALSE, $prefix_key = FALSE)
	{	
		$query = $this->db
