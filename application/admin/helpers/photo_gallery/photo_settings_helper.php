<?php
function helper_photo_settings_form_build($data)
{
	$form_id = 'photo_settings_edit_form';
	$CI = & get_instance();
	...
	foreach($data['img_settings']['img_settings'] as $ms)
	{
		$img_settings['img_settings'][$ms['name']] = $ms['value'];
	}
	
	$CI->form->add_tab('img_settings', 'Настройки фотографий');		
	$CI->form->add_group('img_settings', $img_settings);
