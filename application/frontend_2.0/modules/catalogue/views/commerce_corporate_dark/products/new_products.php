<?php
if(isset($PRS_new['products']) && count($PRS_new['products'])>0)
{
?>
<script>
	var pr_config_highslide_new_products = {
		slideshowGroup: 'pr_new_group',
		transitions: ['expand', 'crossfade']
	};
</script>
<div class="products_carousel_block left_block_margin anythingSlider_vertical" align="center">
<div class="base_left_block">
	<div class="base_left_top"><div class="label"><?=$this->lang->line('base_catalogue_new_text')?></div></div>
