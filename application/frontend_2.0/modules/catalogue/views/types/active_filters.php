...
{
?>
	<div  class="active_filters_block">
		<div class="block">
			<div class="title">
					...
					switch($ms['type_kind'])
					{
						...
						<div class="<?=$ms['type_kind']?>_filter_block filter_block">
							<div class="block">
								...
								<div class="property">
									<div class="checkbox">
										<label for="filter_checkbox_<?=$chkey?>_active">
						...
						<div class="<?=$ms['type_kind']?>_filter_block filter_block">
							<div class="block">
								...
								<div class="properties_block">
									<div class="property">
										<div class="checkbox">
											<label for="active_range_price_filter">
											</label>
											<?=form_checkbox($checkbox_data)?>
										</div>
	...
	<div class="filters_buttons">
		<a href="#" class="activate_filter" id="filter_block_activate_top_button"><span><?=$this->lang->line('products_filter_activate')?></span></a>
		<a href = "#" class="clear_filter" id="filter_block_clear_top_button"><span><?=$this->lang->line('products_filter_clear')?></span></a>
	</div>
