		...
		<table cellspacing="0" cellpadding="0" class="form_table">
			<tr>
				...
				<td valign="middle" width="30%" class="product_total_td">
					<?php
					if(isset($ms['products_prices']['special_total_price']))
					{
						?>
						<div class="price_block form_field"><span class="field_label"><?=$this->lang->line('cart_total_price')?>:</span> <span class="field_value"><s><?=$ms['products_prices']['total_price_string']?></s></span> <span class="field_value"><?=number_format($ms['products_prices']['special_total_price'], 2, ',', ' ')?> <?=$ms['products_prices']['currency_name']?></span></div>
					<? }
					else
					{ ?>
						<div class="price_block form_field"><span class="field_label"><?=$this->lang->line('cart_total_price')?>:</span>      <span class="field_value"><?=$ms['products_prices']['total_price_string']?> <?=$ms['products_prices']['currency_name']?></span></div>
					<? } ?>
