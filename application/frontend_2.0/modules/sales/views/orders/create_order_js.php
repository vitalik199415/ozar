...
$("#create_order").gbc_orders(
{
	...
	activate_url:				'<?=$this->router->build_url('ajax', array('ajax' => 'sales/discount_coupons/ajax_activate_code/'));?>',
	activate_err_mess:			'<?=$this->lang->line('c_o_activate_error_submit')?>'
});
