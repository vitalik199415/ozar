...
<? if($order_data['sales_settings']['address_B_skype'] == 1){ ?> order_required_payment_fields["order_address[B][skype]"] = {required: true}; <? } ?>
<? if($order_data['sales_settings']['address_B_viber'] == 1){ ?> order_required_payment_fields["order_address[B][viber]"] = {required: true}; <? } ?>
